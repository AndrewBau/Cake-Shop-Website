...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            $Q_sortby_price_dsc = "SELECT * FROM products ORDER BY ar DESC; "; //sort all products by price high to low
                                ...
                                <div class="featured__products" id="product__card">
                                    <div class="featured__box">
                                        ...
                                        <a href="product.php?product_id=<?php echo $product_id; ?>" >
                                            <img src="Assets\images\products\<?php echo $row_product['boritokep']; ?>" alt="" class="featured__img avoid__clicks"
                                            style="
                                                object-fit: cover;
                                                width:  232px;
                                                height: 232px;" />

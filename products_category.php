...
<html>
    ...
    <body>
        ...
        <?php 
            ...
            $Q_sortby_price_asc = "SELECT * FROM products ORDER BY ar ASC; "; //Termékeket növekvő sorrendbe teszi
            $Q_sortby_price_dsc = "SELECT * FROM products ORDER BY ar DESC; "; //Termékeket csökkenő sorrendbe teszi
